...
type Props = {
    ...
    add: (link: StoryLink, groupIndex?: number) => void;
    groupIndex?: number;
};

const AddLink = ({ open, setOpen, add, groupIndex }: Props) => {
    ...
    useEffect(
        () => setDisabled(link.trim() === "" || !isValidURL(link.trim())),
        [link],
    );
